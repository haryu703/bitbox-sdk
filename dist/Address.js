...
var Address = /** @class */ (function () {
    ...
    Address.prototype.toLegacyAddress = function (address) {
        ...
        var bitcoincash = bcl.networks.bitcoin;
        switch (prefix) {
            case "bitcoincash":
        ...
        var version = bitcoincash.pubKeyHash;
        switch (type) {
            case "P2PKH":
    ...
    Address.prototype.legacyToHash160 = function (address) {
        var bytes = bcl.address.fromBase58Check(address);
    ...
    Address.prototype.cashToHash160 = function (address) {
        ...
        var bytes = bcl.address.fromBase58Check(legacyAddress);
        return bytes.hash.toString("hex");
    };
    ...
    Address.prototype.hash160ToLegacy = function (hash160, network) {
        if (network === void 0) { network = bcl.networks.bitcoin.pubKeyHash; }
    ...
    Address.prototype.fromXPub = function (xpub, path) {
        ...
        if (xpub[0] === "x")
            ...
            bitcoincash = bcl.networks.testnet;
        var HDNode = bcl.bip32.fromBase58(xpub, bitcoincash);
        var address = bcl.payments.p2pkh({ pubkey: HDNode.derivePath(path).publicKey, network: bitcoincash }).address;
        if (!address) {
    ...
    Address.prototype.fromXPriv = function (xpriv, path) {
        ...
        if (xpriv[0] === "x")
            ...
            bitcoincash = bcl.networks.testnet;
        var HDNode = bcl.bip32.fromBase58(xpriv, bitcoincash);
        var address = bcl.payments.p2pkh({ pubkey: HDNode.derivePath(path).publicKey, network: bitcoincash }).address;
        if (!address) {
    ...
    Address.prototype.fromOutputScript = function (scriptPubKey, network) {
        ...
        return this.toCashAddress(bcl.address.fromOutputScript(scriptPubKey, netParam), true, regtest);
    };
    ...
    Address.prototype._decodeLegacyAddress = function (address) {
        var _a = bcl.address.fromBase58Check(address), version = _a.version, hash = _a.hash;
        var info = bcl.networks;
        var decoded = {
            prefix: "",
            type: "",
            hash: hash,
