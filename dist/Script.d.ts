...
export declare class Script {
    ...
    number: scriptNumber;
    constructor();
    encode(scriptChunks: Array<number | Buffer>): Buffer;
    decode(scriptBuffer: Buffer): Array<number | Buffer>;
    ...
    encodeP2PKHOutput(identifier: Buffer): Buffer;
    ...
    encodeNumber(number: number): Buffer;
