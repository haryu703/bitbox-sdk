...
var Mnemonic = /** @class */ (function () {
    ...
    Mnemonic.prototype.generate = function (bits, wordlist) {
        ...
        if (wordlist === void 0) { wordlist = this.wordLists().english; }
    ...
    Mnemonic.prototype.toKeypairs = function (mnemonic, numberOfKeypairs, regtest) {
        ...
        var network = regtest ? bcl.networks.regtest : undefined;
        var hdNode = bcl.bip32.fromSeed(rootSeedBuffer, network);
        ...
        for (var i = 0; i < numberOfKeypairs; i++) {
            ...
            accounts.push({
                ...
                address: this._address.toCashAddress(bcl.payments.p2pkh({ pubkey: childHDNode.publicKey, network: network }).address, true, regtest)
            });
        }
        return accounts;
    };
